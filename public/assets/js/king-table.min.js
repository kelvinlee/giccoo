$(document).ready(function() {
    if ($(".datatable").length > 0) {
        $(".datatable").dataTable({
            sDom:"<'row'<'col-md-6 hidden-xs'l><'col-md-6'f>r>t<'row'<'col-md-6 hidden-xs'i><'col-md-6'p>>",
        ...
        $(".dataTables_length select").addClass("dropdown");
    }
    ...
    if ($("#jqgrid").length > 0) {
        ...
        resize_the_grid();
        if ($("#jqgrid").length > 0) {
            $("#jqgrid").jqGrid("navGrid", "#jqgrid-pager", {
                add:true,
                edit:true,
                view:true,
                del:true,
